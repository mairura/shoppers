...
g.k.cJ=function(){this.tooltip=new g.mS(this.player,this);g.N(this,this.tooltip);g.IN(this.player,this.tooltip.element,4);this.tooltip.scale=.6;this.Kc=new g.gP(this.player);g.N(this,this.Kc);this.Di=new g.X({D:"div",K:"ytp-miniplayer-scrim"});g.N(this,this.Di);this.Di.Ca(this.element);this.T(this.Di.element,"click",this.kE);var a=new g.X({D:"button",Ga:["ytp-miniplayer-close-button","ytp-button"],X:{"aria-label":"Close"},W:[g.jL()]});g.N(this,a);a.Ca(this.Di.element);this.T(a.element,"click",this.Rk);
a=new g.M2(this.player,this);g.N(this,a);a.Ca(this.Di.element);this.Hs=new g.X({D:"div",K:"ytp-miniplayer-controls"});g.N(this,this.Hs);this.Hs.Ca(this.Di.element);this.T(this.Hs.element,"click",this.kE);var b=new g.X({D:"div",K:"ytp-miniplayer-button-container"});g.N(this,b);b.Ca(this.Hs.element);a=new g.X({D:"div",K:"ytp-miniplayer-play-button-container"});g.N(this,a);a.Ca(this.Hs.element);var c=new g.X({D:"div",K:"ytp-miniplayer-button-container"});g.N(this,c);c.Ca(this.Hs.element);this.JS=new g.IQ(this.player,
this,!1);g.N(this,this.JS);this.JS.Ca(b.element);b=new g.GQ(this.player,this);g.N(this,b);b.Ca(a.element);this.nextButton=new g.IQ(this.player,this,!0);g.N(this,this.nextButton);this.nextButton.Ca(c.element);this.Gi=new g.ZR(this.player,this);g.N(this,this.Gi);this.Gi.Ca(this.Di.element);this.Cc=new g.TQ(this.player,this);g.N(this,this.Cc);g.IN(this.player,this.Cc.element,4);this.aE=new g.X({D:"div",K:"ytp-miniplayer-buttons"});g.N(this,this.aE);g.IN(this.player,this.aE.element,4);a=new g.X({D:"button",
Ga:["ytp-miniplayer-close-button","ytp-button"],X:{"aria-label":"Close"},W:[g.jL()]});g.N(this,a);a.Ca(this.aE.element);this.T(a.element,"click",this.Rk);a=new g.X({D:"button",Ga:["ytp-miniplayer-replay-button","ytp-button"],X:{"aria-label":"Close"},W:[g.qL()]});g.N(this,a);a.Ca(this.aE.element);this.T(a.element,"click",this.F3);this.T(this.player,"presentingplayerstatechange",this.Vc);this.T(this.player,"appresize",this.Bb);this.T(this.player,"fullscreentoggled",this.Bb);this.Bb()};
